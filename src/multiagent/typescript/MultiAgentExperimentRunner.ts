...
export class MultiAgentExperimentRunner extends ExperimentRunner {
  ...
  protected isEpisodeDone(): boolean {
    ...
    // Use the maxStepsPerEpisode property from BaseMultiAgentEnvironment
    const maxStepsReached = this.currentStep >= (this.multiAgentEnvironment as any).maxStepsPerEpisode;
