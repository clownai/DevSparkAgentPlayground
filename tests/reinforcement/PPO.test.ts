...
import { EnvironmentInfo, Experience } from '../../src/types/reinforcement';
...
describe('PPO', () => {
  ...
  test('should initialize with environment information', () => {
    const envInfo: EnvironmentInfo = {
      stateSpace: { shape: [4], low: [-1, -1, -1, -1], high: [1, 1, 1, 1], type: 'continuous' },
      actionSpace: { n: 2, type: 'discrete' },
      actionType: 'discrete'
    };
  ...
  test('should throw error when initializing without environment info', () => {
    expect(() => {
      ppo.initialize(undefined as unknown as EnvironmentInfo);
  ...
  test('should select action after initialization', () => {
    ...
    (tf.tensor().dataSync as jest.Mock).mockReturnValue(mockDistribution);
  ...
  test('should handle continuous action spaces', () => {
    ...
    // Mock action distribution
    (tf.tensor().dataSync as jest.Mock)
  ...
  test('should update with experience', () => {
    ...
    const result1 = ppo.update(experience1);
    ...
    const result2 = ppo.update(experience2);
  ...
  test('should perform batch update with experiences', () => {
    ...
    const result = ppo.batchUpdate(experiences);
